...
This Java program takes in command line arguments from the user to form a line-up of candidates. The user is given the choice to nominate candidates, vote for candidates, switch the voting strategy, and find the winner of the election. These choices will be prompted until the user decides to quit the session.
